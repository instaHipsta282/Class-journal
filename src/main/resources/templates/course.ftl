...
<@c.page>
    ...
    <div class="row m-4">
        <div class="col-md-3">
            <div class="card-deck">
                <div class="card">
                    <img src="/img/${course.getImage()}" class="card-img-top" alt="">
                    ...
                    <#list usersSchedule as key, value>
                        <tr>
                            ...
                            <#list value as schedule>
                                <td
                                        <#if schedule.getPresenceStatus() == "NONE">id="noneColor"</#if>
                                        <#if schedule.getPresenceStatus() == "PRESENCE">id="presenceColor"</#if>
                                        <#if schedule.getPresenceStatus() = "ABSENT">id="absentColor"</#if>
                                >
                                    <p>
                                        <#if schedule.getScore() != "NONE">${schedule.getScore()}<#else>-</#if>
                                    </p>
                                </td>
                            </#list>
                            <#if isAdmin>
                        ...
                        <div class="dropdown show mr-5">
                            ...
                            <form action="/courseList/${course.getId()}/addUser" method="post">
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    ...
                                    <input class="form-control ${(typeError??)?string('is-invalid', '')}" id="userName"
                                           type="text" placeholder="Search.." name="userName"/>
                                    <#list usersForCourse as userForCourse>
                                        <ul class="list-group" id="myList">
                                            <li class="list-group-item">
                                                <div class="input-group-text mr-2">
                                                    <label for="usersId"></label>
                                                    <input class="mr-2" type="checkbox" id="usersId"
                    ...
                    <div class="card card-body">
                        <div id="changeSchedule">
                            <div class="form-group mt-3">
                                <form method="post" action="/courseList/${course.getId()}/changeSchedule"
                                      enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label for="user" class="col-sm-5 col-form-label">Student</label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="form-group row">
                                        <label for="score" class="col-sm-5 col-form-label">Score</label>
                                        <div class="col-sm-7">
